public class App4 {
     ...
     * of three numbers.
     */
    private static int computeSum(int par1, int par2){
        return par1 + par2;
    }
    private static int computeSum(int par1, int par2, int par3){
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("The sum of 10 and 45 is: "+ App4.computeSum(10, 45));
        System.out.println("The sum of 15 and 45 and 60 is: "+ App4.computeSum(15, 45, 60));
        /**
